...
import { LANGUAGES, CRUD_ACTIONS, CommonUtils } from '../../../utils/constant';
...
class ManageDoctor extends Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if (prevProps.allRequiredDoctorInfor !== this.props.allRequiredDoctorInfor) {
            // console.log('anh pham check this.props.allReDrIn', this.props.allRequiredDoctorInfor)
            ...
            console.log('anh pham check data new', dataSelectClinic);
    ...
    render() {
        let { hasOldData } = this.state;
        console.log('anh pham check state', this.state)
        return (
